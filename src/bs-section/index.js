...
import { PanelBody, TextControl, SelectControl, Button, ColorPicker, RangeControl, TabPanel } from '@wordpress/components';
...
registerBlockType('bootstrap-blocks/bs-section', {
    edit({ attributes, setAttributes, clientId }) {
        ...
        const rowCount = select('core/block-editor').getBlockOrder(clientId)?.length || 0;
        ...
        return (
            <>
                ...
                <InspectorControls>
                    ...
                    <PanelBody title="Background" initialOpen={false}>
                        <div style={{ marginBottom: '16px' }}>
                            <label style={{ display: 'block', marginBottom: '8px', fontWeight: '600' }}>Background Type</label>
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
                                    <input
                                        ...
                                        onChange={(e) => setAttributes({ backgroundType: e.target.value })}
                                        style={{ margin: 0 }}
                                    />
                                    <span>None</span>
                                </label>
                                ...
                                <div style={{ display: 'flex', gap: '10px', marginTop: '10px' }}>
                                    <div>
                                        ...
                                        <RangeControl
                                            label="Stop 1 (%)"
                                            value={gradientStop1}
                                            onChange={(value) => setAttributes({ gradientStop1: value })}
                                            min={0}
                                            max={100}
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <RangeControl
                                            label="Stop 2 (%)"
                                            value={gradientStop2}
                                            onChange={(value) => setAttributes({ gradientStop2: value })}
                                            min={0}
                                            max={100}
                                        />
                                    </div>
                ...
                <div {...useBlockProps({ className: uniqueClassName, style: blockStyle })}>
                    {/* Editor header */}
                    <div style={{
                        marginBottom: '12px', padding: '8px 12px', backgroundColor: 'rgba(0, 124, 186, 0.1)', borderRadius: '4px', maxWidth: '95%',marginRight: 'auto',marginLeft: 'auto' }}>
                        <div style={{ color: '#007cba', fontWeight: 'bold', marginBottom: '4px', fontSize: '16px' }}>BS Section</div>
                        <div style={{ display: 'flex', gap: '15px', alignItems: 'center' }}>
                            <Button onClick={addRow} isPrimary>
                                + Add Row
                            </Button>
                            <span style={{ color: '#007cba' }}>Rows: {rowCount}</span>
                        </div>
                    </div>
