...
export const generateTestimonialHTML = (data) => {
    const { uniqueId, blockTitle, testimonials, slickConfig, sliderStyle, wordLimit, showDate, showRating, slideBackground, titleColor, textColor, borderColor, borderWidth, borderRadius, slideGap, arrowTheme, dotColor, dotActiveColor } = data;
                        ...
                        <div class="card-header">
                            <div class="author-avatar">
                                ${testimonial.avatar ? 
                                    ...
                                    `<span class="avatar-initial">${testimonial.name.charAt(0).toUpperCase()}</span>`
                                }
                            </div>
